...
def get_config():
    ...
    global seed_weight 
    seed_weight = random.randint(1, 1000000)
    C.system.init_seed = seed_weight # will change the weight initialization
...
if __name__ == '__main__':
    ...
    for i in range(110):
        ...
        train_dataset = ChickenRabbitDataset(config.data, split='train', seed=_seed)
        test_dataset  = ChickenRabbitDataset(config.data, split='test', seed=_seed)
        ...
        f = open("question1_Normal_ChickenRabbit.txt", "a")
